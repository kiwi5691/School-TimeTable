  ...
  <div id="bg">
    ...
    <div id="login_wrap">
      <div id="login">
        ...
        <span>
                    <form>
                        <p class="form"><input type="text" v-model="loginInfoVo.username" id="user" placeholder="username"></p>
                        <p class="form"><input type="password" v-model="loginInfoVo.password" id="passwd" placeholder="password"></p>
                        <input type="button" value="Log in" class="btn"  v-on:click="login" style="margin-right: 20px;">
                    </form>
  ...
  export default {
    ...
    methods: {
      login() {
        ...
        that.$axios.post('/login',loginParams)
